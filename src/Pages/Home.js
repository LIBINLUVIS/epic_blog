...
function Home() {
  ...
  return (
     ...
     <div className='home'>
     <div style={{overflow:'hidden',position:'fixed',backgroundColor:'white'}} className={classes.fotter_hide}>
      ...
      <div className='home-main'>
       ...
       <div className='background'>
         <img src={banner} className={classes.banner_img} id="home_banner_img"/>
       ...
       <div style={{height:'100px',bottom:'0px',position:'fixed',
       width:'100%',borderStyle:'solid',
       borderWidth:'thin',borderColor:'grey'
       }} className={classes.fotter_mobile}>
        <div style={{display:'flex',justifyContent:'space-between',
        marginLeft:'30%',marginRight:'30%',marginTop:'30px'}}>
        <Link to='/signup'>
